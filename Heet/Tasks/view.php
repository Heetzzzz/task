...
<form action="view.php" id="form">
	...
	<div>
		...
		<?php
			...
			{  
				?>
					<a href = "view.php?search=<?php echo $search; ?>&column=<?php echo $column; ?>&order=<?php echo $asc_or_desc == 'asc' ? 'desc' : 'asc'; ?>&num_rows=<?php echo $rowperpage; ?>&page=<?php echo $page_number; ?>"  class="btn"><?php echo $page_number; ?> 
					</a>
				<?php  
			} 
